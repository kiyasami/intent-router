...
export interface ProfileProvider<TMeta extends ProfileMetadata = ProfileMetadata> {
...
export interface LocalProfileStore<TMeta extends ProfileMetadata = ProfileMetadata> {
